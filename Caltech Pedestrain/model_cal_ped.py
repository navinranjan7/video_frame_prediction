...
#        ### Optical Decoder Block 3
        ...
        return([output, optical_rnn1, d_optical4, d_optical3, d_optical2, d_optical1])
#%%        
...
#            print(k)
        ...
        mse_loss_avg = (test_loss/(249000 - past_sequence - batch_size - 180000)*batch_size)
        p_loss_avg = (test_loss/(249000 - past_sequence - batch_size - 180000)*batch_size)
        print(f"Test Loss at Epochs {epoch} : SSIM {test_loss_avg}  MSE {mse_loss_avg}  PSNR {p_loss_avg}")
        
    model.save_weights(f"/home/navin/paper_5/dataset/Output/model_proposed_cal_ped.h5")   
    model_optical.save_weights(f"/home/navin/paper_5/dataset/Output/model_optical_cal_ped.h5") 
...
def test(batch_size = 8):
    ...
    for k in range(180000, 249000 - past_sequence - batch_size, batch_size):
        ...
        for index in range (0,8):
            ...
            out1 = (out1*255)
            cv2.imwrite(f"/home/navin/paper_5/dataset/Output/result1_70/{k+index}.png", out)
            cv2.imwrite(f"/home/navin/paper_5/dataset/Output/result1_1_70/{k+index}.png", out1)
    ...
    return [ssim_loss_holder, mse_loss_holder, psnr_loss_holder] 


    #%%
with tf.device('/gpu:3'):
   train_epoch()
   SSIM_result, MSE_result, PSNR_result = test()
    #%%
