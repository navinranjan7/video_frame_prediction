...
#        total_gradient_normalized = total_gradient/(4*640*480)
    total_gradient_normalized = total_gradient/(y_true.shape[0] * y_true.shape[1] * y_true.shape[2] * y_true.shape[3])
...
#    mean_square_error = tf.reduce_sum(mean_square_error)
    ...
    squared_error_normalized = total_squared_error/(y_true.shape[0] * y_true.shape[1] * y_true.shape[2] * y_true.shape[3])    
...
def absolute_distance_loss(y_true, y_pred):
    ...
    abs_error_normalized = total_abs_error/((y_true.shape[0]) * y_true.shape[1] * y_true.shape[2] * y_true.shape[3])    
