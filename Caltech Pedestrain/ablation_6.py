...
#                o = cv2.hconcat([out,out1])
                    cv2.imwrite(f"/home/navin/paper_5/dataset/Output/ablation_6_1/result/{k+index}.png", out)
#                    cv2.imwrite(f"/home/navin/paper_5/dataset/Output/ablation_6_2/{epoch}_{k+index}.png", out1)
